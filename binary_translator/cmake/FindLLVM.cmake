...
if (LLVM_INCLUDE_DIR)
  ...
  exec_program(${LLVM_CONFIG_EXECUTABLE} ARGS --obj-root   OUTPUT_VARIABLE LLVM_OBJ_ROOT )
  MESSAGE(STATUS "LLVM object root: " ${LLVM_OBJ_ROOT})
  exec_program(${LLVM_CONFIG_EXECUTABLE} ARGS --src-root   OUTPUT_VARIABLE LLVM_SRC_ROOT )
...
function(llvm_get_libraries OUT_VAR)
  STRING (REPLACE ";" " " COMPONENTS "${ARGN}")
  exec_program(${LLVM_CONFIG_EXECUTABLE} ARGS --libs "${COMPONENTS}" OUTPUT_VARIABLE LIB_NAMES)
  SET (${OUT_VAR} "${LIB_NAMES}" PARENT_SCOPE)
endfunction(llvm_get_libraries)
